...
Построим остаточную сеть.Необходимо вынести обратную дугу с весом равным пропускной способности. 
...
В остаточной сети не найдено увеличивающих путей, но можно перераспределить потоки. По дуге BC, вместо 4х потоков отправим 2.
Эти два потока отправим по пути b -> a -> t. Так же по пути s -> c-> d-> t, отправим два потока вместо предыдущих.
...
| 2 | s, a                            | b, c,d, t       |   4+6+3+8=21        |
| 3 | s, b                            | a, c, d,t       |   6+6+2+2=16        |
| 4 | s, c                            | a, b, d,t       |     6+4+5+3+8=26    |
| 5 | s, d                            | a, b, c, t      |      6+4+6+2+8=26   |
|   | **s + пара вершин из a, b, c,d**|                 |                     |
| 6 | s, a, b                         | c,d, t          | 6+8+2+=16           |
| 7 | s, a, c                         | b,d, t          | 4+3+8+3+8=26        |
| 8 | s, b, c                         | a, d,t          | 6+2+5+8=21          |
| 9 | s, a, d                         | b,c, t          | 4+6+3+8+2+8=31      |
| 10 | s, b, d                        | a,c, t          | 6+6+2+2+2+8=26      |
| 11| s, c, d                         | a, b,t          | 6+4+5+3+8=26        |
|   | **s + три вершины из a, b, c,d**|                 |                     |
| 12 | s, a, b, c                     | d,t             | 8+8=16              |
| 13 | s, a, b, d                     | c,t             | 6+8+2+2+8=26        |
| 14 | s, a, d, c                     | b,t             | 4+3+8+8+3=26        |
| 15 | s, d, b, c                     | a,t             | 6+8+2=16          |
