...
Создадим начальную популяцию из 8 случайных особей. Бинарный код придумаем самостоятельно:
...
Особи с их приспособленностью: X<sub>8</sub>(77), X<sub>6</sub>(73), X<sub>2</sub>(67), , X<sub>1</sub>(63)
...
Было сформировано 3 поколение. Алгоритм завершен. По сравнению с начальным поколением суммарная приспособленность выросла с 507 до 550, наблюдается эволюция. 

Самая сильная особь 3 поколения - X<sub>8</sub> с весом 20 и показателем приспособленности 77. Таким образом, можно сказать, что максимальная стоимость предметов - 77, с общим весом 20. Набор предметов, обеспечивающих максимальную стоимость: 1, 2, 3, 7. Свободного место в рюкзаке: 0. 
